...
Everything below is the technical detail behind [README.md](../README.md):
why the extension is built around containers, how it detects and intercepts
external URLs, its known limitations, what has not been verified yet, and
how to develop, test, and release it.
...
## Installing from source (temporary add-on)
